...
public class VisitedItemListAdapter extends ArrayAdapter<PlaceModel.Results> {
  private List<PlaceModel.Results> results;
  private Context mContext;

  public VisitedItemListAdapter(@NonNull Context context) {
    super(context, 0);
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      viewHolder.placeView.enableButtonBar(false);
